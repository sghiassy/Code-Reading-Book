 ...
 */
/* $XConsortium: igs_bank.s /main/4 1996/02/21 17:13:50 kaleb $ */
 ...
 *
 *	IGSSetRead      - Set the read-bank pointer
 *	IGSSetWrite     - Set the write-bank pointer
 *	IGSSetReadWrite - Set both bank pointers to the same bank
 *
 ...
 * In this case, make sure the ChipUse2Banks field of the IGSChipRec is
 * set to FALSE in the igs_driver.c file.
 */

	FILE("igs_bank.s")	/* Define the file name for the .o file */
 ...
 */
	ALIGNTEXT4		
	GLOBL	GLNAME(IGSSetReadWrite)
GLNAME(IGSSetReadWrite):

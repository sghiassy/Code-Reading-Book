...
* MD5 Hash                                       *
*************************************************/
void MD5::hash(const byte input[BLOCKSIZE])
   {
...
* Update a MD5 Hash                              *
*************************************************/
void MD5::update_hash(const byte input[], u32bit length)
   {
   count += length;
...
* Finalize a MD5 Hash                            *
*************************************************/
void MD5::final(byte output[HASHLENGTH])
   {

...
* MD5MAC Hash                                    *
*************************************************/
void MD5MAC::hash(const byte input[BLOCKSIZE])
   {
...
/*************************************************
* Update a MD5MAC Calculation                    *
*************************************************/
void MD5MAC::update_mac(const byte input[], u32bit length)
   {
   count += length;
...
/*************************************************
* Finalize a MD5MAC Calculation                  *
*************************************************/
void MD5MAC::final(byte output[MACLENGTH])
   {
...
* MD5MAC Key Schedule                            *
*************************************************/
void MD5MAC::set_key(const byte key[], u32bit length) throw(InvalidKeyLength)
   {

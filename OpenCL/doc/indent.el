; This Emacs Lips code defines the indentation style used in OpenCL. If doesn't
...
; M-x c-set-style <RET> and then enter "opencl". Alternately, put something
; like this in your .emacs file to make it the default style:

; (add-hook 'c++-mode-common-hook
;   (function (lambda()
;     (c-add-style "opencl" opencl t))))

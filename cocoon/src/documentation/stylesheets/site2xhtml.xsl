...
<html>
      <head>
        ...
        <script language="JavaScript" src="resources/script.js" type="text/javascript"></script>
      </head>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
          ...
          <tr>
            <td width="100%" height="35" valign="top" align="right" colspan="2" bgcolor="#0086b2">
              <img src="{$header}?label={NetUtils:encodePath(/site/document/title)}" hspace="0" vspace="0" border="0" alt="{/site/document/title}" align="right"/>           
            </td>
          </tr>
          <tr>

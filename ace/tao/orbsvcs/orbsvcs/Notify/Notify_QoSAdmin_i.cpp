/* -*- C++ -*- Notify_QoSAdmin_i.cpp,v 1.6 2000/08/30 01:29:01 pradeep Exp */

#include "Notify_QoSAdmin_i.h"

ACE_RCSID(Notify, Notify_QoSAdmin_i, "Notify_QoSAdmin_i.cpp,v 1.6 2000/08/30 01:29:01 pradeep Exp")

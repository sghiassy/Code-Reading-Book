// Notify_Worker_Task.cpp,v 1.6 2001/04/02 19:44:25 pradeep Exp

#include "Notify_Worker_Task.h"
#include "Notify_Command.h"

ACE_RCSID(Notify, Notify_Worker_Task, "Notify_Worker_Task.cpp,v 1.6 2001/04/02 19:44:25 pradeep Exp")

// DSAddin.cpp : Implementation of CVCFListener
#include "stdafx.h"
...
STDMETHODIMP CVCFListener::OnConnection(IApplication* piApplication, VARIANT_BOOL bFirstTime, long dwCookie, VARIANT_BOOL* pbOnConnection)
{
	// prepare to fail!
...
STDMETHODIMP CVCFListener::OnDisconnection(VARIANT_BOOL bLastTime)
{
	// cleanup!
	m_pCommands->Release();
	m_pCommands = NULL;

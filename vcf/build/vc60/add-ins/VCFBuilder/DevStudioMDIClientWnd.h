...
// Construction
public:
	CDevStudioMDIClientWnd(HWND hWndSubclass, IApplication* pDevStdioApp);
...
protected:
	...
	//}}AFX_MSG
	IApplication* m_pDevStdioApp;
	afx_msg LRESULT OnMDIActivate( WPARAM wParam, LPARAM lParam );
	afx_msg LRESULT OnMDICreateWnd( WPARAM wParam, LPARAM lParam );
	afx_msg LRESULT OnMDIDestroyWnd( WPARAM wParam, LPARAM lParam );
	DECLARE_MESSAGE_MAP()
};

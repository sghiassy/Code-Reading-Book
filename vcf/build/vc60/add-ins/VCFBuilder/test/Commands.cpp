...
HRESULT CCommands::XApplicationEvents::WindowActivate(IDispatch* theWindow)
{
	...
	OutputDebugString( "CCommands::XApplicationEvents::WindowActivate()\n" );
	CMDIChildWnd* mdiChild =  ((CMDIFrameWnd*)AfxGetApp()->GetMainWnd())->MDIGetActive();// CDevStudioMainWnd::globalDevStudioMainWnd;
	if ( NULL != mdiChild ) {
		CString s;
		mdiChild->GetWindowText( s );
		OutputDebugString( s );
		
		if ( firstTime ) {
			//CViewHost* vHost = new CViewHost();
			CMDIFrameWnd* frame = (CMDIFrameWnd*)AfxGetApp()->GetMainWnd();

			
			CMDIChildWnd* ch = frame->CreateNewChild( RUNTIME_CLASS(CMDIChildWnd), IDS_STRING5, NULL, NULL );
...
STDMETHODIMP CCommands::TestCommandMethod() 
{
	...
	::MessageBox(NULL, "Test Command invoked.", "Test", MB_OK | MB_ICONINFORMATION);

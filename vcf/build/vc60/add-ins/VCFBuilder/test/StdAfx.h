...
#if !defined(AFX_STDAFX_H__7CEB6857_9660_4D8D_871B_70C38ABECFA7__INCLUDED_)
#define AFX_STDAFX_H__7CEB6857_9660_4D8D_871B_70C38ABECFA7__INCLUDED_
...
void GetLastErrorDescription(CComBSTR& bstr);		// Defined in test.cpp
#define VERIFY_OK(f) \
	{ \
		HRESULT hr = (f); \
		if (hr != S_OK) \
...
#endif // !defined(AFX_STDAFX_H__7CEB6857_9660_4D8D_871B_70C38ABECFA7__INCLUDED)
